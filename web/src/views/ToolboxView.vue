<template>
    ...
    <main class="p-5">
        ...
        <ul role="list" class="mt-6 grid grid-cols-1 gap-x-4 gap-y-10 border-t border-b border-gray-200 py-6 sm:grid-cols-2">
            <li class="flow-root">
                    ...
                    <div>
                        <h3 class="text-sm font-medium text-gray-900">
                            <a href="javascript://" class="focus:outline-none">
                                ...
                                <span>Create a Genesis File</span>
                ...
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <div>
                        <h3 class="text-sm font-medium text-gray-900">
                            <a href="javascript://" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                                <span>Precompile Gallery</span>
                                <span aria-hidden="true"> &rarr;</span>
                            </a>
                        </h3>

                        <p class="mt-1 text-sm text-gray-500">
                            Choose a precompiled contract to deploy to your Subnet.
                        </p>
                    </div>
                </div>
            </li>
            ...
            <li class="flow-root">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Deploy system services like: databases, security, etc.
                        </p>
                    </div>
                </div>
            </li>
            ...
            <li class="flow-root">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Perform a comprehensive security scan for ANY local or remote node.
                        </p>
                    </div>
                </div>
            </li>
            ...
            <li class="flow-root">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Easily &amp; safely manage Virtual Machine (VM) upgrades.
                        </p>
                    </div>
                </div>
            </li>
