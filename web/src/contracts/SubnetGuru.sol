 ...
 *
 * SubnetGuru - Provides on-chain state management for the Gurus managing the
 *              network of Subnet Validator nodes.
 *
 * Version 22.9.18
 *
 * https://avasdao.org
...
contract SubnetGuru is Owned {
     ...
     */
    string private _namespace = 'subnetguru';

    /* Initialize Guru version. */
    ...
    constructor() {
        ...
        if (_predecessor != address(0x0)) {
            ...
            uint lastRevision = SubnetGuru(predecessor).getRevision();
     ...
     * Set (Guru) Version
     *
     * Sets version number to the latest version of the Guru app.
     */
    function setVersion(
        uint _newVersion
    ) public returns(bool) {
